(function($) {
  ...
  ///=============  Sidebar Popup  =============\\\
  $('.header__area-menubar-right-box-sidebar-popup-icon').on(
    'click',
    function () {
  ...
  if ($('.team__details-skills-item-bar').length) {
    $('.team__details-skills-item-bar').appear(
      function () {
        var el = $(this);
  ...
  if ($('.skill-area__one-right-skill-item-bar').length) {
    $('.skill-area__one-right-skill-item-bar').appear(
      function () {
        var el = $(this);
        var percent = el.data('width');
        $(el).css('width', percent + '%');
  ...
  $('.faq-collapse-item-card').click(function () {
